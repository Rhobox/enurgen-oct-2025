...
function App() {
    ...
    // This helps handle transition state where the selectedFile state may not be set yet
    useEffect(() => {
        if (selectedFiles) {
            handleUpload()
        }
    ...
    // Helps with browser compatibility between chromium and firefox, hides default input button
    const handleClick = () => {
